  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <Button
        ...
        className="text-[var(--color-text-secondary)] hover:text-[var(--color-text)] disabled:opacity-30"
      >
        <ChevronLeft className="size-4" />
      </Button>

      <span className="text-xs text-[var(--color-text-tertiary)] tabular-nums min-w-[3.5rem] text-center">
